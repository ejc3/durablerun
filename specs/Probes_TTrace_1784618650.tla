---- MODULE Probes_TTrace_1784618650 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Probes_TTrace_1784618650.json", _TETrace)
...
\*
\*trace == IODeserialize("Probes_TTrace_1784618650.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Probes_TTrace_1784618650 ----
CONSTANTS
    Tasks = { t1 }
    MaxRuns = 3
    MaxTime = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 07:24:11 UTC 2026