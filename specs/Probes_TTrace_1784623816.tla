---- MODULE Probes_TTrace_1784623816 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Probes_TTrace_1784623816.json", _TETrace)
...
\*
\*trace == IODeserialize("Probes_TTrace_1784623816.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Probes_TTrace_1784623816 ----
CONSTANTS
    Tasks = { t1 }
    MaxRuns = 3
    MaxTime = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 08:50:17 UTC 2026