---- MODULE Probes_TTrace_1784645426 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Probes_TTrace_1784645426.json", _TETrace)
...
\*
\*trace == IODeserialize("Probes_TTrace_1784645426.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([lastCtx |-> [run |-> 0, gen |-> 0],claimGen |-> <<1, 0, 0>>,firstStarted |-> (t1 :> 0),channel |-> {[run |-> 1, gen |-> 1]},contexts |-> {},nextRun |-> 2,waitAt |-> <<1, 0, 0>>,runTask |-> <<t1, t1, t1>>,taskState |-> (t1 :> "sleeping"),runPayload |-> <<0, 0, 0>>,lastAction |-> "TimeAdvance",eventState |-> (e1 :> 0),availableAt |-> <<1, 0, 0>>,now |-> 1,attempts |-> (t1 :> 0),policy |-> (t1 :> "none"),waitEv |-> <<e1, "none", "none">>,relaunchCount |-> <<0, 0, 0>>,nextCtx |-> 2,cancelAt |-> (t1 :> 5),activatedGen |-> <<1, 0, 0>>,wakeEvent |-> <<e1, "none", "none">>,leaseDeadline |-> <<2, 0, 0>>,infraRetries |-> (t1 :> 0),runAttempt |-> <<1, 0, 0>>,hops |-> (t1 :> 1),runState |-> <<"sleeping", "unused", "unused">>]),
    ([lastCtx |-> [run |-> 0, gen |-> 0],claimGen |-> <<2, 0, 0>>,firstStarted |-> (t1 :> 0),channel |-> {[run |-> 1, gen |-> 1], [run |-> 1, gen |-> 2]},contexts |-> {},nextRun |-> 2,waitAt |-> <<0, 0, 0>>,runTask |-> <<t1, t1, t1>>,taskState |-> (t1 :> "running"),runPayload |-> <<0, 0, 0>>,lastAction |-> "Claim",eventState |-> (e1 :> 0),availableAt |-> <<1, 0, 0>>,now |-> 1,attempts |-> (t1 :> 0),policy |-> (t1 :> "none"),waitEv |-> <<"none", "none", "none">>,relaunchCount |-> <<0, 0, 0>>,nextCtx |-> 2,cancelAt |-> (t1 :> 5),activatedGen |-> <<1, 0, 0>>,wakeEvent |-> <<e1, "none", "none">>,leaseDeadline |-> <<3, 0, 0>>,infraRetries |-> (t1 :> 0),runAttempt |-> <<1, 0, 0>>,hops |-> (t1 :> 1),runState |-> <<"running", "unused", "unused">>])
    >>
----
...
---- CONFIG Probes_TTrace_1784645426 ----
CONSTANTS
    Tasks = { t1 }
    MaxRuns = 3
    MaxTime = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 14:50:26 UTC 2026