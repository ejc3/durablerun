---- MODULE Probes_TTrace_1784643890 ----
...
_inv ==
    ~(
        ...
        runTask = (<<t1, t1, t1>>)
        /\
        taskState = ((t1 :> "cancelled"))
        /\
        runPayload = (<<0, 0, 0>>)
        /\
        lastAction = ("CancelExplicit")
        /\
        eventState = ((e1 :> 0))
        /\
        availableAt = (<<0, 0, 0>>)
        ...
        hops = ((t1 :> 0))
        /\
        runState = (<<"cancelled", "unused", "unused">>)
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Probes_TTrace_1784643890.json", _TETrace)
...
\*
\*trace == IODeserialize("Probes_TTrace_1784643890.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([lastCtx |-> [run |-> 0, gen |-> 0],claimGen |-> <<1, 0, 0>>,firstStarted |-> (t1 :> 0),channel |-> {[run |-> 1, gen |-> 1]},contexts |-> {[run |-> 1, gen |-> 1, id |-> 1]},nextRun |-> 2,waitAt |-> <<0, 0, 0>>,runTask |-> <<t1, t1, t1>>,taskState |-> (t1 :> "cancelled"),runPayload |-> <<0, 0, 0>>,lastAction |-> "CancelExplicit",eventState |-> (e1 :> 0),availableAt |-> <<0, 0, 0>>,now |-> 0,attempts |-> (t1 :> 0),policy |-> (t1 :> "none"),waitEv |-> <<"none", "none", "none">>,relaunchCount |-> <<0, 0, 0>>,nextCtx |-> 2,cancelAt |-> (t1 :> 5),activatedGen |-> <<1, 0, 0>>,wakeEvent |-> <<"none", "none", "none">>,leaseDeadline |-> <<0, 0, 0>>,infraRetries |-> (t1 :> 0),runAttempt |-> <<1, 0, 0>>,hops |-> (t1 :> 0),runState |-> <<"cancelled", "unused", "unused">>])
    >>
----
...
---- CONFIG Probes_TTrace_1784643890 ----
CONSTANTS
    Tasks = { t1 }
    MaxRuns = 3
    MaxTime = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 14:24:51 UTC 2026