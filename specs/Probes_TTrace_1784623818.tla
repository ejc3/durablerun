---- MODULE Probes_TTrace_1784623818 ----
...
_inv ==
    ~(
        ...
        hops = ((t1 :> 1))
        /\
        runState = (<<"sleeping", "unused", "unused">>)
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Probes_TTrace_1784623818.json", _TETrace)
...
\*
\*trace == IODeserialize("Probes_TTrace_1784623818.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([lastCtx |-> [run |-> 0, gen |-> 0],claimGen |-> <<0, 0, 0>>,firstStarted |-> (t1 :> 5),channel |-> {},contexts |-> {},nextRun |-> 2,waitAt |-> <<0, 0, 0>>,runTask |-> <<t1, t1, t1>>,taskState |-> (t1 :> "pending"),runPayload |-> <<0, 0, 0>>,lastAction |-> "Spawn",eventState |-> (e1 :> 0),availableAt |-> <<0, 0, 0>>,now |-> 0,attempts |-> (t1 :> 0),policy |-> (t1 :> "both"),waitEv |-> <<"none", "none", "none">>,relaunchCount |-> <<0, 0, 0>>,nextCtx |-> 1,cancelAt |-> (t1 :> 2),activatedGen |-> <<0, 0, 0>>,wakeEvent |-> <<"none", "none", "none">>,leaseDeadline |-> <<0, 0, 0>>,infraRetries |-> (t1 :> 0),runAttempt |-> <<1, 0, 0>>,hops |-> (t1 :> 0),runState |-> <<"pending", "unused", "unused">>]),
    ([lastCtx |-> [run |-> 0, gen |-> 0],claimGen |-> <<1, 0, 0>>,firstStarted |-> (t1 :> 5),channel |-> {[run |-> 1, gen |-> 1]},contexts |-> {},nextRun |-> 2,waitAt |-> <<0, 0, 0>>,runTask |-> <<t1, t1, t1>>,taskState |-> (t1 :> "running"),runPayload |-> <<0, 0, 0>>,lastAction |-> "Claim",eventState |-> (e1 :> 0),availableAt |-> <<0, 0, 0>>,now |-> 0,attempts |-> (t1 :> 0),policy |-> (t1 :> "both"),waitEv |-> <<"none", "none", "none">>,relaunchCount |-> <<0, 0, 0>>,nextCtx |-> 1,cancelAt |-> (t1 :> 2),activatedGen |-> <<0, 0, 0>>,wakeEvent |-> <<"none", "none", "none">>,leaseDeadline |-> <<2, 0, 0>>,infraRetries |-> (t1 :> 0),runAttempt |-> <<1, 0, 0>>,hops |-> (t1 :> 0),runState |-> <<"running", "unused", "unused">>]),
    ([lastCtx |-> [run |-> 1, gen |-> 1],claimGen |-> <<1, 0, 0>>,firstStarted |-> (t1 :> 0),channel |-> {[run |-> 1, gen |-> 1]},contexts |-> {[run |-> 1, gen |-> 1, id |-> 1]},nextRun |-> 2,waitAt |-> <<0, 0, 0>>,runTask |-> <<t1, t1, t1>>,taskState |-> (t1 :> "running"),runPayload |-> <<0, 0, 0>>,lastAction |-> "Activate",eventState |-> (e1 :> 0),availableAt |-> <<0, 0, 0>>,now |-> 0,attempts |-> (t1 :> 0),policy |-> (t1 :> "both"),waitEv |-> <<"none", "none", "none">>,relaunchCount |-> <<0, 0, 0>>,nextCtx |-> 2,cancelAt |-> (t1 :> 2),activatedGen |-> <<1, 0, 0>>,wakeEvent |-> <<"none", "none", "none">>,leaseDeadline |-> <<2, 0, 0>>,infraRetries |-> (t1 :> 0),runAttempt |-> <<1, 0, 0>>,hops |-> (t1 :> 0),runState |-> <<"running", "unused", "unused">>]),
    ([lastCtx |-> [run |-> 1, gen |-> 1],claimGen |-> <<1, 0, 0>>,firstStarted |-> (t1 :> 0),channel |-> {[run |-> 1, gen |-> 1]},contexts |-> {},nextRun |-> 2,waitAt |-> <<5, 0, 0>>,runTask |-> <<t1, t1, t1>>,taskState |-> (t1 :> "sleeping"),runPayload |-> <<0, 0, 0>>,lastAction |-> "AwaitMiss",eventState |-> (e1 :> 0),availableAt |-> <<5, 0, 0>>,now |-> 0,attempts |-> (t1 :> 0),policy |-> (t1 :> "both"),waitEv |-> <<e1, "none", "none">>,relaunchCount |-> <<0, 0, 0>>,nextCtx |-> 2,cancelAt |-> (t1 :> 2),activatedGen |-> <<1, 0, 0>>,wakeEvent |-> <<e1, "none", "none">>,leaseDeadline |-> <<2, 0, 0>>,infraRetries |-> (t1 :> 0),runAttempt |-> <<1, 0, 0>>,hops |-> (t1 :> 1),runState |-> <<"sleeping", "unused", "unused">>])
    >>
----
...
---- CONFIG Probes_TTrace_1784623818 ----
CONSTANTS
    Tasks = { t1 }
    MaxRuns = 3
    MaxTime = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 21 08:50:19 UTC 2026