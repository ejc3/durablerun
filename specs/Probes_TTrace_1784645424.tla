---- MODULE Probes_TTrace_1784645424 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Probes_TTrace_1784645424.json", _TETrace)
...
\*
\*trace == IODeserialize("Probes_TTrace_1784645424.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Probes_TTrace_1784645424 ----
CONSTANTS
    Tasks = { t1 }
    MaxRuns = 3
    MaxTime = 4
