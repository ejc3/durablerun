...
- **A live BUILD.md entry that owns another document's list.** When a live `BUILD.md` entry owns
  every item in a separate tracking document, those items need not be repeated as sub-bullets.
